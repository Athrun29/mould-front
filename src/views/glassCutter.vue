...
<script>
  ...
  export default {
    ...
    methods: {
      //获取表格数据
      postData() {
        this.$http.post(this.testUrl.url + "/dic/glassCutter/list",
          {
            pager: this.pager,
      ...
      delData() {
        ...
        this.$http.post(this.testUrl.url + "/dic/glassCutter/del",
          this.selected)
          .then(function (res) {
            if (res.body.success == 1) {
      ...
      edit(index){
        this.clearModel();
        this.$http.get(this.testUrl.url + "/dic/glassCutter/get/"+encodeURI(this.tableBody[index].id))
          .then(function (res) {
            if (res.body.success == 1) {
      ...
      add() {
        ...
        this.$http.post(this.testUrl.url + "/dic/glassCutter/save",
          this.addModel)
          .then(function (res) {
            if (res.body.success == 1) {
